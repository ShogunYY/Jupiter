...
public class TicketMasterClient {
	...
	private static final String API_KEY = "KIqWjm6uUG7RGjsZmU4KmftucBY5zkg7";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		try {
			...
			// Use InputStream instead of OutputStream when getting response from server as client.
